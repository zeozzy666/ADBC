...
aa.debug("zeal111","AE Found for Activity: " + actEntity[act]["Approving Entity"].fieldValue);		
aa.debug("zeal222","AE Found for Activity: " + actEntity[act]["Approving Entity"].fieldValue.trim().toUpperCase());
							//Grab Task
							var foundAE = "";
							for (var i in wfObj) {
								fTask = wfObj[i];	
aa.debug("zeal333", fTask.getTaskDescription().trim().toUpperCase());			
